...
import { Download, Plus, Search, X, Battery, ClipboardList, File } from 'lucide-react';
      ...
      <div className="flex flex-col gap-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-500">Manage battery purchase records</p>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Invoice Number</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Date</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Supplier Name</th>
