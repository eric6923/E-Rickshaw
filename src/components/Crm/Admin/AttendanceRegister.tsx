          ...
          <div className="md:hidden">
            {attendanceRecords.length === 0 ? (
              ...
              <div className="space-y-4 p-4">
                {attendanceRecords.map((record, index) => (
                  <div key={index} className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <p className="font-medium text-gray-900 dark:text-gray-100">{record.date}</p>
                      </div>
                      <div>
                        <p className="text-gray-500 dark:text-gray-400">Status</p>
                        <p className="font-medium text-gray-900 dark:text-gray-100">{record.status}</p>
                      </div>
                    </div>
                  </div>
                ))}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-xl w-full sm:w-[600px] max-h-[90vh] overflow-y-auto relative">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Add Attendance Record</h2>
              </div>
