        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-gray-700">
              <tr>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Quotation Number</th>
                ...
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Father's Name</th>
                <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Phone Number 1</th>
              ...
              {quotations.length === 0 ? (
                ...
                quotations.map((quotation, index) => (
                  <tr key={index} className="text-gray-900 dark:text-gray-300">
                    <td className="px-6 py-4 whitespace-nowrap">{quotation.quotationNumber}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{quotation.fatherName}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{quotation.amount}</td>
                  </tr>
                ))
              )}
            </tbody>
                ...
                {Object.keys(formData).map((key) => (
                  <div key={key}>
                    ...
                    <input
                      ...
                      name={key}
                      value={formData[key as keyof QuotationData]}
