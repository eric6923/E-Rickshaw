...
const TemporaryDriving = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setDrivingRecords([...drivingRecords, formData]);
              ...
              {drivingRecords.length === 0 ? (
                ...
                drivingRecords.map((record, index) => (
                  <tr key={index} className="text-gray-900 dark:text-gray-300">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{record.driverPhoneNumber}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">{record.driverSignature}</td>
              ...
              <div className="grid grid-cols-1 gap-4">
                {Object.keys(formData).map((key) => (
                  <div key={key}>
                    ...
                    <input
                      type={key === 'driverAmount' ? 'number' : 'text'}
                      name={key}
                      value={formData[key as keyof TemporaryDrivingData]}
